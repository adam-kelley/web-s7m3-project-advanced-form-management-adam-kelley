...
const userSchema = yup.object().shape({
  username: yup.string().required(e.usernameRequired)
...
export default function App() {
  ...
  useEffect(() => {
    userSchema.isValid(values)
      .then(valid => setFormEnabled(valid))
      ...
      <form onSubmit={onSubmit}>
        ...
        <div className="inputGroup">
          <fieldset>
            ...
            <label>
              <input checked={values.rust == 'rust'} onChange={onChange} type="radio" name="favLanguage" value="rust" />
              Rust
            </label>
          </fieldset>
